...
// find_empty_cell (su, row, col) find an empty cell with the least number of, 
//   but at least 1, possible solutions. If such a cell exists, the function 
//    mutates row and col to be the indices of that cell and returns the 
//    number of solutions. If no such cell exists, it return 0
// requires: row and col are valid pointers.
// effects:  might mutate row and col 
// time: O(n^5)
